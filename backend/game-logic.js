...
const gameManager = new GameManager(broadcastStatus, broadcastStatusFromServer, sendMove, sendNextRegister, sendNextTurn, sendTurnEnd);
...
function sendTurnEnd() {
    io.sockets.in(gameId).emit(Constants.SOCKET_TURN_END);
}
